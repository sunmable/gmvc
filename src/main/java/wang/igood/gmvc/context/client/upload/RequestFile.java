 ...
 * <p>
 * 文件内容可以存储于内存或者临时目录。需要自己实现存储。临时目录会清除。
 * </p>
 */
public class RequestFile {

	protected static final Logger logger = LoggerFactory.getLogger(RequestFile.class);
	 ...
	 * 
	 * @return the content type, or <code>null</code> if not defined (or no file has
	...
	/**
	 * Return whether the uploaded file is empty, that is, either no file has been
	 * chosen in the multipart form or the chosen file has no content.
	 */
	 ...
	 * invoked again. Therefore, call this method just once to be able to work with
