package wang.igood.gmvc.context.client.upload;
...
public class UploadRequestResolver {
	...
	/**
	 * Standard Servlet spec context attribute that specifies a temporary directory
	 * for the current web application, of type <code>java.io.File</code>.
	 */
	...
	public MultipartParsingResult resolveMultipart(final HttpServletRequest request) throws Exception {
	 ...
	 * MultipartParsingResult, containing Spring MultipartFile instances and a Map
	 ...
	 * matches, else creates a new FileUpload instance with the same configuration
	 * other than the desired encoding.
	 * 
	 * @param encoding
	 ...
	 * subclasses.
	 * <p>
	 * The default implementation checks the request encoding, falling back to the
	 * default encoding specified for this resolver.
	 * 
	 * @param request
	 ...
	 * <code>org.apache.commons.fileupload.disk.DiskFileItemFactory</code> instance.
	...
	/**
	 * Return the temporary directory for the current web application, as provided
	...
	public static class MultipartParsingResult {
		 ...
		 */
		public MultipartParsingResult(Map<String, LinkedList<RequestFile>> mpFiles, Map<String, String[]> mpParams) {
			this.multipartFiles = new LinkedHashMap<String, LinkedList<RequestFile>>(
					Collections.unmodifiableMap(mpFiles));
		...
		/**
		 * Return the multipart parameters as Map of field name to form field String
		 * value.
		 */
